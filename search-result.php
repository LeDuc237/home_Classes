...
<html lang="en">
    <head>
        ...
        <title>SmartGen || search result </title>
...
<hr color="red" />
                    ...
                    <div class="row gx-5">
                                    <?php
$sql="SELECT * from tblteacher where (isPublic='Yes') and (TeacherSub  like '%$searchdata%'|| TeachAddress like '%$searchdata%')";
                            ...
                            <div class="card h-100 shadow border-0">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <a class="text-decoration-none link-dark stretched-link" href="teacher-details.php?tid=<?php echo $row->ID;?>" target="_blank">
                                        ...
                                        <h7 class="card-title mb-3"> <small> Generally located at : </small> <?php  echo htmlentities($row->TeachAddress);?></h7></a>
