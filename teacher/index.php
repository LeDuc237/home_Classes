...
<head>
    ...
    <title>SmartGen || Teacher login</title>
...
<body class="bg-dark" style="background-image: url('images/school.jpg'); background-repeat: no-repeat; background-size:cover;">
    ...
    <div class="sufee-login d-flex align-content-center flex-wrap" >
        <div class="container">
            ...
            <h3 style="color:white"id="google_translate_element">Translate </h3>
                <div class="login-logo">
                    <img src = "../../Large.png" width = "150px">
                    <h3 style="color:white">Teacher login </h3>
                    <hr  color="red"/>
                </div>
