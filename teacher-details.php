...
<html lang="en">
    <head>
        ...
        <title>SmartGen || Teachers Details</title>
        <!-- Favicon-->
...
<?php
$tid=intval($_GET['tid']);
$sql="SELECT * from tblteacher where isPublic='Yes' and ID='$tid'";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?> 
   ...
   <tr>
                  ...
                  <tr>
                      ...
                      <td><?php  echo htmlentities($row->TeachAddress);?></td>
                  </tr>
                  <tr>
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mb-4">
                                                Contact US at
                                                <br />
                                                <a href="https://api.whatsapp.com/send?phone=><?php  echo htmlentities($row->ContactUs);?>" target = "_blank"> whatsapp = +237651203488 </a>
                                                 </p>
                                            <h5>OR</h5>
<form method="post">
...
<p><input type="tel"ol name="mobileno" placeholder="Enter your mobile no (+237)" class="form-control" ></p>
